...
EMSCRIPTEN_BINDINGS(scalatrix) {
    ...
    emscripten::class_<MOS>("MOS")
        ...
        .property("structure_L_vec", &MOS::structure_L_vec)
        .property("structure_s_vec", &MOS::structure_s_vec)
        .property("structure_chroma_vec", &MOS::structure_chroma_vec)
        .property("a", &MOS::a)
        .property("b", &MOS::b)
        .property("n", &MOS::n)
        .property("a0", &MOS::a0)
        ...
        .property("structureImpliedAffine", &MOS::structureImpliedAffine)
